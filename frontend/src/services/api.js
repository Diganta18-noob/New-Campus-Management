...
export const classroomsAPI = {
  ...
  getAvailability: (id, params) =>
    api.get(`/classrooms/${id}/availability`, { params }),
};
...
export const batchesAPI = {
  ...
  getAvailableTrainers: (excludeBatchId, batchStartDate) =>
    api.get("/batches/available-trainers", {
      params: {
        ...(excludeBatchId && { excludeBatchId }),
        ...(batchStartDate && { batchStartDate }),
      },
    }),
  getAvailableClassrooms: (excludeBatchId, batchStartDate) =>
    api.get("/batches/available-classrooms", {
      params: {
        ...(excludeBatchId && { excludeBatchId }),
        ...(batchStartDate && { batchStartDate }),
      },
  ...
  getAvailableLearners: (excludeBatchId, batchStartDate) =>
    api.get("/batches/available-learners", {
      params: {
        ...(excludeBatchId && { excludeBatchId }),
        ...(batchStartDate && { batchStartDate }),
      },
